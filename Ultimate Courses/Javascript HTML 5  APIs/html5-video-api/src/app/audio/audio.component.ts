...
export class AudioComponent implements OnInit {
  ...
  public ngOnInit(): void {
    ...
    let volumeToggle = player?.querySelector('.audio-player__mute');
    volumeToggle?.addEventListener('click', () => this.toggleVolume(volumeToggle, volume, media));

    // Volume up and down control
    let volume = player?.querySelector('.audio-player__volume');
